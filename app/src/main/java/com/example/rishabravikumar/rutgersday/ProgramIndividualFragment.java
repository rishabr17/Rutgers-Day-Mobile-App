...
public class ProgramIndividualFragment extends Fragment {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(button.getText().toString().equalsIgnoreCase("add")) {
                    if(latLng != null)
                        ((MainActivity) getActivity()).itineraryCards.add(new ProgramsCard(_campus, _programTitle, _time, _SID, 0, latLng));
                    else
                        ((MainActivity) getActivity()).itineraryCards.add(new ProgramsCard(_campus, _programTitle, _time, _SID, 0, null));
                    button.setText("Remove");
                }
